            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="bold xlTxt m-b-20 text-center">Details of consultant doctor</div>

                        <form class="cd-form" method="post" action="save_step10_data.php">
                            <p class="fieldset">
                                <span class="lableOFInput">Fees </span>
                                <input class="InputSelectTags" value="<?php echo $row['consultation_fees'] ?>" id="fees" name="fees" type="number" step='0.01' placeholder="00.00">
                            </p>
