    ...
    <div class="terms">
        ...
        <div class="container">
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        <div class="bold xlTxt m-b-20 text-center">State & Medical Council Of India Registration</div>
                        <p class="m-b-15 light-bold mdTxt text-center">
                            Please upload your State & Medical Council Of India registration. Only licensed and genuine doctors are listed on Bonanza.<br>
                            Acceptable documents: Medical Registration Certificate
                        </p>
                        <form class="cd-form" method="post" action="save_step7_data.php">
                            <p class="fieldset">
                                <span class="lableOFInput">State Medical </span>
                                <input type="file" class="InputSelectTags" name="fileId" id="fileId" onchange="imageUploaded()" placeholder="Upload State Medical Registration" required>
                            </p>
                            <input type="hidden" name="img" id="img">

                            <p class="fieldset">
                                <span class="lableOFInput">Medical Council Of India </span>
                                <input type="file" class="InputSelectTags" name="fileId" id="fileId" onchange="imageUploaded()" placeholder="Upload State Medical Registration" required>
                            </p>
                            <input type="hidden" name="img" id="img">
