            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="bold xlTxt m-b-20 text-center">PAN Card</div>

                        <p class="m-b-15 light-bold mdTxt text-center">
                            Please upload your PAN Card to ensure that the ownership of your profile remains with only you.<br>
                            Acceptable documents: Aadhar Card, driving licence, voter card, any other govt. Id
                        </p>


                        <form class="cd-form" method="post" action="save_step6_data.php">
                            <p class="fieldset">
                                <span class="lableOFInput">Upload PAN Card</span>
                                <input type="file" class="InputSelectTags" id="myinput" name="fileId" id="fileId" onchange="imageUploaded()" placeholder="Select document" required>
                            </p>
