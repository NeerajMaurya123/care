            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="bold xlTxt m-b-20 text-center">Map location</div>

                        <form class="cd-form" method="post" action="#">
                            <p class="fieldset">
                                <input class="full-width has-padding has-border" id="address" name="address" type="text" placeholder="Enter street address">
                            </p>
                            <p class="fieldset">
                                <input class="full-width has-padding has-border" id="city" name="city" type="text" placeholder="Enter city">
                            </p>
                            <p class="fieldset">
                                <input class="full-width has-padding has-border" id="state" name="state" type="text" placeholder="Enter state">
                            </p>
                            <p class="fieldset">
                                <input class="full-width has-padding has-border" id="pincode" name="pincode" type="text" placeholder="Enter pincode">
                            </p>
