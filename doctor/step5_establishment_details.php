            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="bold xlTxt m-b-20 text-center">Establishment basic details</div>

                        <form class="cd-form" method="post" action="save_step5_data.php">
                            <p class="fieldset">
                                <span class="lableOFInput">Name</span>
                                <input class="InputSelectTags" id="name" value="<?php echo $row['establishment_name'] ?>" name="name" type="text" placeholder="Establishment Name" />
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">Address</span>
                                <input class="InputSelectTags" id="address" value="<?php echo $row['establishment_address'] ?>" name="address" type="text" placeholder="Address">
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">Locality</span>
                                <input class="InputSelectTags" id="locality" value="<?php echo $row['establishment_locality'] ?>" name="locality" type="text" placeholder="Locality">
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">City</span>
                                <input class="InputSelectTags" id="city" value="<?php echo $row['establishment_city'] ?>" name="city" type="text" placeholder="City">
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">State</span>
                                <input class="InputSelectTags" id="state" value="<?php echo $row['establishment_state'] ?>" name="state" type="text" placeholder="State">
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">Pincode</span>
                                <input class="InputSelectTags" id="pincode" value="<?php echo $row['establishment_pincode'] ?>" name="pincode" type="text" placeholder="Pincode">
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">Establishment Type</span>
                                <select class="InputSelectTags" name="establishment_type">
                                    <option selected hidden><?php echo $row['establishment_type'] ?></option>
                                    <option>the owner of establishment</option>
                                    <option>have rented at other establishment</option>
                                    <option>a consultant doctor</option>
                                    <option>practicing at home</option>
                                </select>
                            </p>

                            <p class="m-b-15 light-bold mdTxt text-center">
                                Accepted proofs (Any one)<br>
                                Clinic Registration Proof / Waste Disposal Proof / Tax Reciept + NOC from the owner
                            </p>

                            <p class="fieldset">
                                <span class="lableOFInput">Select Document</span>
                                <input type="file" class="InputSelectTags" name="fileId" id="fileId" onchange="imageUploaded()" placeholder="Select document" required>
                            </p>
                            <input type="hidden" name="img" id="img">
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <p class="fieldset">
                                <input class="full-width" type="submit" value="Next" onclick="displayString()">
                            </p>
                        </form>
