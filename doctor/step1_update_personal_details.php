...
<head>
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        $stmt2 = $connect->prepare('select * from doctors_certificates where doctor_id=?');
        $stmt2->bind_param('s', $id);
        $stmt2->execute();
        $result2 = $stmt2->get_result();
        $NoRow = $result2->num_rows;
        if ($NoRow > 0) {
            $src = $result2->fetch_array();
            $srcImg = $src["doctor_photo"];
        } else {
            $srcImg = '';
        }
    ?>
            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="bold xlTxt m-b-20 text-center">Let's build your dedicated profile</div>

                        <form class="cd-form" method="post" action="save_step1_data.php">
                            <p class="fieldset">
                                <span class="lableOFInput">Specialization</span>
                                <select name="specialization" class="InputSelectTags" required>
                            ...
                            <p class="fieldset">
                                <span class="lableOFInput"> Gender</span>
                                <select name="gender" class="InputSelectTags" required>
                            ...
                            <p class="fieldset">
                                <span class="lableOFInput">City</span>
                                <input class="InputSelectTags" id="city" name="city" value="<?php echo $row['city'] ?>" type="text" placeholder="Enter City" required>
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">State</span>
                                <input class="InputSelectTags" id="state" name="state" value="<?php echo $row['state'] ?>" type="text" placeholder="Enter State" required>
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput"> Pincode</span>
                                <input class="InputSelectTags" id="pincode" name="pincode" value="<?php echo $row['pincode'] ?>" type="text" placeholder="Enter Pincode" required>
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput"> Self Date Of Birth</span>
                                <input class="InputSelectTags" id="self_date_of_birth" value="<?php echo $row['self_date_of_birth'] ?>" name="self_date_of_birth" type="date" required>
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput"> Spouse Date Of Birth</span>
                                <input class="InputSelectTags" id="spouse_date_of_birth" value="<?php echo $row['spouse_date_of_birth'] ?>" name="spouse_date_of_birth" type="date" required>
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput"> Anniversary Date</span>
                                <input class="InputSelectTags" id="anniversary_date" value="<?php echo $row['anniversary_date'] ?>" name="anniversary_date" type="date" required>
                            </p>

                            <p class="fieldset">
                                <span class="lableOFInput">Upload Profile </span>
                                <input type="file" class="InputSelectTags" id="myinput" name="fileId" id="fileId" onchange="imageUploaded()" placeholder="Upload State Medical Registration" >
                            </p>
                            <input type="hidden" name="img" id="img">
                            <input type="hidden" name="id" value="<?php echo $id; ?>">

                            <p class="fieldset">
                                <input class="full-width" type="submit" value="Continue">
                            </p>
                        </form>
                        <div class="" id="dummy" style="width:200px; height:200px">
                            <img src="<?php echo $srcImg ?>" id="previewImg" class="previewImg" alt="" srcset="">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <?php
