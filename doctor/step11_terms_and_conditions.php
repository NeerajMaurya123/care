            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="bold xlTxt m-b-20 text-center">Declaration</div>


                        <form class="cd-form" method="post" action="save_step11_data.php">
                            <p class="fieldset">
                                I, therefore declare that the information provided by me is true to the best knowledge of me. If found false at any level, please cancel by registration from Bonanza care.<br><br>
                                <input type="checkbox" name="checkbox" id="checkbox" required>&nbsp;&nbsp;<b>Sign the declaration</b>
                            </p>

                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <p class="fieldset">
                                <input class="full-width" type="submit" value="Submit my form">
                            </p>
                        </form>
