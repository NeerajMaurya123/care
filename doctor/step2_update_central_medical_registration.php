            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <form class="cd-form" method="post" action="save_step2_data_central.php">

                            <div class="bold xlTxt m-b-20 text-center">Medical Council Of India Registration</div>

                            <p class="fieldset">
                                <span class="lableOFInput">Registration No</span>
                                <input class="InputSelectTags" value="<?php echo $row['mci_registraton_no']; ?>" id="mci_registraton_no" name="mci_registraton_no" type="text" placeholder="Enter Medical Registration No.">
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">Registration Council</span>
                                <input class="InputSelectTags" value="<?php echo $row['mci_registration_council']; ?>" id="mci_registration_council" name="mci_registration_council" type="text" placeholder="Enter Registration Council">
                            </p>

                            <p class="fieldset">
                                <span class="lableOFInput">Registration Year</span>
                                <input class="InputSelectTags" value="<?php echo $row['mci_registration_year']; ?>" id="mci_registration_year" onkeypress="return onlyNumberKey(event)" name="mci_registration_year" type="text" maxlength="4" minlength="4" placeholder="YYYY" placeholder="Enter Registration Year">
                            </p>
