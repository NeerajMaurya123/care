            ...
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <form class="cd-form" method="post" action="save_step2_data_state.php">
                            <div class="bold xlTxt m-b-20 text-center">State Medical Registration</div>

                            <p class="fieldset">
                                <span class="lableOFInput">Registration No</span>
                                <input class="InputSelectTags" value="<?php echo $row['registration_no']; ?>" id="registration_no" name="registration_no" type="text" placeholder="Enter Medical Registration No." required>
                            </p>
                            <p class="fieldset">
                                <span class="lableOFInput">Registration Council</span>
                                <input class="InputSelectTags" value="<?php echo $row['registration_council']; ?>" id="registration_council" name="registration_council" type="text" placeholder="Enter Registration Council" required>
                            </p>

                            <p class="fieldset">
                                <span class="lableOFInput">Registration Year</span>
                                <input class="InputSelectTags" value="<?php echo $row['registration_year']; ?>" id="registration_year" onkeypress="return onlyNumberKey(event)" name="registration_year" type="text" maxlength="4" minlength="4" placeholder="YYYY" placeholder="Enter Registration Year" required>
                            </p>
