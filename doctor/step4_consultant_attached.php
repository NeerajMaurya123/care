    ...
    <div class="terms">
        ...
        <div class="container">
            <section class="clearfix">
                <div class="row">
                    <div class="col-md-9">
                        <div class="bold xlTxt m-b-20 text-center">Consultant Attached</div>
                        
                        <form class="cd-form" method="post" action="save_step4_data.php">
                        <p class="fieldset">
                                <span class="lableOFInput">Enter name of hospital / clinic / consulting chamber </span>
                                <input class="InputSelectTags" id="name_of_hospital" name="name_of_hospital" type="text">
                        </p>
                        <p class="fieldset">
                                <span class="lableOFInput">Enter days of week you visit</span>
                                <input class="InputSelectTags" id="days" name="days" type="text">
                        </p>
                        <p class="fieldset">
                                <span class="lableOFInput">Enter timings of visit</span>
                                <input class="InputSelectTags" id="timings" name="timings" type="text">
                        </p>
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <p class="fieldset">
                                <input class="full-width" type="submit" value="Save and add more">
                            </p>
                        </form>
